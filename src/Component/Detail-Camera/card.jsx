...
const Carddetail = ({ guid_device, type, leftcard, leftcard2, rightcard, rightcard2, rightcard3 }) => {
  return (
    ...
    <div className="w-full lg:w-3/4 space-y-4 mr-10 mt-7">
      <div className='flex justify-between bg-white rounded-lg transition-all shadow-md p-4'>
        ...
        <div className="bg-white rounded-lg shadow-md hover:shadow-lg p-6 transition-all duration-300 ease-in-out">
