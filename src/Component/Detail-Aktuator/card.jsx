  ...
  return (
    <div className="flex space-x-4">
      <div className="w-1/3 p-2">
        <div className="p-8 bg-white rounded-lg transition-transform transform hover:scale-105">
        ...
        <div className="mt-6 p-8 bg-white rounded-lg transition-transform transform hover:scale-105">
