          ...
          <div className="p-3 px-4 bg-white rounded-lg shadow-sm border border-gray-200 relative">
            <div className="flex flex-col">
              <div className="flex items-center mb-1">
                ...
                <h1 className="text-3xl font-bold text-gray-900">Histori Aktuator</h1>
              </div>
              <p className="text-gray-600 text-md ml-4">
                Data & Status catatan lengkap dan real-time mengenai aktivitas Aktuator.
              </p>
            </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900 mb-2">Aktuator 1</h1>
