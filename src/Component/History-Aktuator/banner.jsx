  ...
  useEffect(() => {
    const fetchDeviceData = async () => {
      try {
        ...
        if (deviceResponse.data.type === "Aktuator") {
          ...
          Content1={
            <div className="mb-4 flex justify-between">
              <div>
                ...
                <p className="text-gray-500 text-sm">Catatan histori lengkap mengenai aktivitas Aktuator.</p>
              </div>
              <button
                ...
                {tableData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((tableItem, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left" className="py-3 px-6">
                      <span
                        className={`px-3 py-1 ${status === "On" ? "text-green-500" : "text-red-500"}`}
                      >
                        {status}
                      </span>
                    </TableCell>
